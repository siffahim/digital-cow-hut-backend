...
const createCowData = (0, catchAsync_1.default)((req, res) =>
...
const getCowCollections = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield cow_service_1.CowService.getCowCollectionsFromDB(
      filters,
      paginationOptions
    );
    (0, sendResponse_1.default)(res, {
